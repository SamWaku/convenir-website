  ...
  return (
    <div className=" bottom-0 md:h-80 md:flex w-full pt-10">
      ...
      <div className=" bg-[#4e4e4e] md:w-[34rem] md:h-0 h-[17rem] md:text-left text-center text-white  md:grid md:grid-cols-1 md:px-8  ">
        <div className=" md:px-0 px-24 pt-8  md:py-0 py-4 md:pl-10">
      ...
      <div className=" font-normal bg-[#00215B] md:w-[60rem] md:h-0 h-[16rem] md:text-left text-center  text-white md:px-10 md:py-10 py-4 ">
